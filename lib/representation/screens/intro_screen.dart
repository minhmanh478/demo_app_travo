...
import 'package:demo_app_travo/representation/widgets/button_widget.dart';
  ...
  Widget _buildItemIntroScreen(String image, String title, String description,
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: kMediumPading * 2),
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: kMediumPading),
              Text(
                description,
